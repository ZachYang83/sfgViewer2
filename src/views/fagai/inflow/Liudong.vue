...
import liuchu_hj from "../inflow/dataPan/Liuchu_huji.vue";
import liuchu_zb from "@/views/fagai/inflow/dataPan/Liuchu_zhanbi.vue";
...
export default {
  ...
  methods: {
    ...
    loadWMS() {
      ...
      MAP.addSource("sfg_liuru", {
        type: "vector",
        scheme: "tms",
        tiles: [
          "https://zwfw.credit.gdgov.cn/geoserver/gwc/service/tms/1.0.0/gpzi%3Asfg_liuru@EPSG%3A900913@pbf/{z}/{x}/{y}.pbf",
        ],
      });
      MAP.addLayer({
        id: "sfg_liuru",
  ...
  destroyed() {
    let _this = this;
    removeLayers(MAP, ["sfg_liuru-hl", "sfg_liuru_sym", "sfg_liuru"]);
