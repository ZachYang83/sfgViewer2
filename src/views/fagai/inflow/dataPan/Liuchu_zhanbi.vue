...
export default {
  ...
  methods: {
    setChart(datas) {
      ...
      let monthData = [
        { key: "2月", value: datas.monthdata[0] },
        { key: "3月", value: datas.monthdata[1] },
        { key: "4月", value: datas.monthdata[2] },
        { key: "5月", value: datas.monthdata[3] },
        { key: "6月", value: datas.monthdata[4] },
        { key: "7月", value: datas.monthdata[5] },
        { key: "8月", value: datas.monthdata[6] },
        { key: "9月", value: datas.monthdata[7] },
        { key: "10月", value: datas.monthdata[8] },
      ];
      let datax = [];
      let datay = [];
